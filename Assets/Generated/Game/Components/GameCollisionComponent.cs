...
public partial class GameEntity {
    ...
    public void AddCollision(Entitas.IEntity newHitting, Entitas.IEntity newHitBy) {
        var index = GameComponentsLookup.Collision;
        var component = (CollisionComponent)CreateComponent(index, typeof(CollisionComponent));
        component.hitting = newHitting;
        component.hitBy = newHitBy;
        AddComponent(index, component);
    }

    public void ReplaceCollision(Entitas.IEntity newHitting, Entitas.IEntity newHitBy) {
        var index = GameComponentsLookup.Collision;
        var component = (CollisionComponent)CreateComponent(index, typeof(CollisionComponent));
        component.hitting = newHitting;
        component.hitBy = newHitBy;
