...
namespace UI
{
    public class PowerUpPanelManager : MonoBehaviour, IEventManagerHandling
    {
        ...
        private List<Powerups.PowerUp> _powerUpsInUse;
        ...
        private void Awake()
        {
            _powerUpsInUse = new List<Powerups.PowerUp>();
            AddHandlers();
        }
        ...
        {
            var powerUp = (Powerups.PowerUp) data;
        ...
        private void OnPowerUpIsActivated(object data)
        {
            ...
            switch (powerUp.type)
            {
                case PowerUpType.SideFire: 
                    Contexts.sharedInstance.game.playerEntity
                        .AddSideFirePowerup(true);
                    break;
                case PowerUpType.DoubleBullets: 
                    Contexts.sharedInstance.game.playerEntity
                        .AddDoubleFirePowerup(true);
                    break;
                case PowerUpType.DoubleFireRateBullets: 
                    Contexts.sharedInstance.game.playerEntity
                        .AddDoubleRatePowerup(Contexts.sharedInstance.game.gameConstants.value.fireRate);
                    break;
                case PowerUpType.DoubleSpeedBullets: 
                    Contexts.sharedInstance.game.playerEntity
                        .AddDoubleSpeedPowerup(Contexts.sharedInstance.game.gameConstants.value.fireSpeed);
                    break;
                case PowerUpType.CloneTank: 
                    Contexts.sharedInstance.game.playerEntity
                        .AddClonePowerup(true);
                    break;
            }
